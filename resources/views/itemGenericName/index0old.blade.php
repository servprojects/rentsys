...
<div class="card mt-5">
  <h2 class="card-header">RenSys</h2>
  <div class="card-body">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <a class="btn btn-success btn-sm" href="{{ route('item-generic-name.create') }}"> <i class="fa fa-plus"></i> Create New Product</a>
        </div>
        ...
        <table class="table table-bordered table-striped mt-4">
            ...
            <tbody>
            @forelse ($itemGenericName as $ign)
                <tr>
                    <td>{{ ++$i }}</td>
                    <td>{{ $ign->name }}</td>
                    <td>{{ $ign->details }}</td>
